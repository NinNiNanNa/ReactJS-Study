...
1. sytle을 전역으로 적용하는 방법 - index.js
  import "./styles.css";

2. 해당 컴포넌트에 직접적으로 적용하는 방법 - Button.js
...
3. CSS-Module
  ...
  - 적용법
      1) 해당 컴포넌트상단에 import 할때 앞에 이름을 지정 - Button.js
        import styles from "./Button.module.css";
      2) 클래스에 적용시킬때는 "1)에서 지정한 이름.클래스명" 을 호출
        <button className={styles.btn}>{text}</button>
      3) 여러 개의 클래스를 적용할 때는 백틱(`)을 사용
